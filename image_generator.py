...
def generate_images(cover_path, background_path, artists, release, lyrics, bot_username):
    ...
    draw1.text((60, 50), f"BOT: {bot_username}", font=font_medium, fill="white")
    ...
    draw1.multiline_text((60, y_text), artist_wrapped, font=font_large, fill="white", spacing=10)
    draw1.multiline_text((60, y_text + artist_height + spacing_between), release_wrapped, font=font_large, fill="white", spacing=10)
    draw1.text((60, HEIGHT - 100), "t.me/chmpns_music", font=font_small, fill="white")
    ...
    draw2.multiline_text((COVER_WIDTH + 60, lyrics_y), lyrics_wrapped, font=font_medium, fill="white", spacing=10)
